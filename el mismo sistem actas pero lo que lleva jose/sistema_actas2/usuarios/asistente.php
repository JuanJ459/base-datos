...
<body>
                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="sm:ml-6 flex justify-between w-full">
                        <div class="flex space-x-4">
                            ...
                            <a href="asistente.php" class="bg-white text-black px-3 py-2 rounded-md text-sm font-medium"
                                aria-current="page">Asistentes</a>
                            <a href="programa.php"
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text"
                                            ...
                                            name="txtNombre" name="txtNombre" required value="<?php echo $txtNombre ?>"
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="text"
                                            class="mt-1 p-2 block w-full shadow-sm sm:text-sm border border-blue-200 rounded-md focus:outline-none focus:border-red-500"
                                            name="txtNombre" name="txtApellido" required
                                            value="<?php echo $txtApellido ?>" placeholder="" id="txt4" require="">
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        ...
                                        <input type="email"
                                            class="mt-1 p-2 block w-full shadow-sm sm:text-sm border border-blue-200 rounded-md focus:outline-none focus:border-red-500"
                                            name="txtNombre" name="txtCorreo" required value="<?php echo $txtCorreo ?>"
                                    ...
                                    <div class="col-span-6 sm:col-span-3">
                                        <label class="block text-sm font-medium text-gray-700" for="">Acta a la que
                                            asiste:</label>
                                        <input type="number"
                                            class="mt-1 p-2 block w-full shadow-sm sm:text-sm border border-blue-200 rounded-md focus:outline-none focus:border-red-500"
                                            name="txtNombre" name="txtListaAsistente" required
                                            value="<?php echo $txtListaAsistente ?>" placeholder="" id="txt8"
                                            require="">
                                        <br>
                                    </div>
                                </div>
    ...
    -->
        ...
        <div class="flex flex-col w-10/12 mx-auto absolute mx-auto inset-x-0 top-14">
            <h1 class="text-center text-4xl font-semibold mt-10 text-white">Asistentes</h1>
            <div></div>
                ...
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class='px-6 py-4 whitespace-nowrap'> <?php echo $asistente['nombre'] ?>
                                    <?php echo $asistente['apellido'] ?> </td>
                                <td class='px-6 py-4 whitespace-nowrap'> <?php echo $asistente['correo'] ?> </td>
                                <td class='px-6 py-4 whitespace-nowrap'> <?php echo $asistente['nombre_acta'] ?> </td>
                                <td class='px-6 py-4 whitespace-nowrap'>
                                    <form action="" method="post">
                                        <input type="hidden" name="txtId"
                                            value="<?php echo $asistente['idasistentes'] ?>">
                                        <input type="hidden" name="txtNombre"
                                            value="<?php echo $asistente['nombre'] ?>">
                                        <input type="hidden" name="txtApellido"
                                            value="<?php echo $asistente['apellido'] ?>">
                                        <input type="hidden" name="txtCorreo"
                                            value="<?php echo $asistente['correo'] ?>">
                                        <input type="hidden" name="txtListaAsistente"
                                            value="<?php echo $asistente['lista_asistente'] ?>">
