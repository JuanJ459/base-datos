...
<body>
                ...
                <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
                    ...
                    <div class="sm:ml-6 flex justify-between w-full">
                        <div class="flex space-x-4">
                            ...
                            <a href="facultad.php" class="bg-white text-black px-3 py-2 rounded-md text-sm font-medium"
                                aria-current="page">Facultad</a>
    ...
    <div class="bg-blue-600 h-32 w-full">
        ...
        <div class="flex flex-col w-10/12 mx-auto absolute mx-auto inset-x-0 top-14">
            <h1 class="text-center text-4xl font-semibold mt-10 text-white">Facultades</h1>
            <div></div>
                ...
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
                        <table class="min-w-full divide-y divide-gray-200">
                            ...
                            <tr>
                                <td class='px-6 py-4 whitespace-nowrap'> <?php echo $facultad['nombre'] ?></td>
