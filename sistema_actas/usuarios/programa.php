                ...
                <div class="modal-dialog modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLongTitle">Creación de un nuevo programa</h5>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input type="number" class="form-control" name="txtIdFacultad" required value="<?php echo $txtIdFacultad ?>" placeholder="" id="txt8" require="">
                                    <br>
                                </div>
                            </div>
                        </div>
            ...
            <table CLASS="table table-hover table-bordered">
                ...
                <?php foreach ($listaP as $programa) { ?>
                    <tr>
                        ...
                        <td> <?php echo $programa['nombre_facultad'] ?> </td>
                        <td>
                            <form action="" method="post">
                                <input type="hidden" name="txtId" value="<?php echo $programa['idprograma'] ?>">
                                <input type="hidden" name="txtNombre" value="<?php echo $programa['nombre'] ?>">
                                <input type="hidden" name="txtIdFacultad" value="<?php echo $programa['idfacultad'] ?>">
